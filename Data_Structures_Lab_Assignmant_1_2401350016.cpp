...
// function for menu-driven user input
void mainMenu() {
    InventoryManagementSystem grocery;
    int choice;
    do {
        ...
        cout << "6. Update Price-Quantity Table\n";
        cout << "7. Display Price-Quantity Table (Row Major)\n";
        cout << "8. Display Price-Quantity Table (Column Major)\n";
        cout << "9. Add Rare Item\n";
        cout << "10. Display Rare Items\n";
        cout << "11. Check Low Stock\n";
        cout << "12. Calculate Total Inventory Value\n";
        cout << "0. Exit\n";
        cout << "Enter your choice: ";
        cin >> choice;
        cin.ignore();

        int id, qty, priceRange, qtyRange, restockFreq;
        string name;
        float price, value;
        ...
        switch (choice) {
            case 1:
                ...
                grocery.insertItem(id, name, qty, price);
                break;
            case 2:
                cout << "Enter Item ID to delete: "; cin >> id;
                grocery.deleteItem(id);
                break;
            case 3:
                cout << "Enter Item ID to search: "; cin >> id;
                if (InventoryItem* item = grocery.searchItemById(id)) item->displayItem();
                break;
            case 4:
                cout << "Enter Item Name to search: "; cin.ignore(); getline(cin, name);
                if (InventoryItem* item = grocery.searchItemByName(name)) item->displayItem();
                break;
            case 5:
                grocery.displayAllItems();
                break;
            case 6:
                cout << "Enter Price Range (0-4): "; cin >> priceRange;
                cout << "Enter Quantity Range (0-3): "; cin >> qtyRange;
                cout << "Enter Value: "; cin >> value;
                grocery.updatePriceQuantityTable(priceRange, qtyRange, value);
                break;
            case 7:
                grocery.displayPriceQuantityRowMajor();
                break;
            case 8:
                ...
                break;
            case 9:
                cout << "Enter Item ID for rare item: "; cin >> id;
                cout << "Enter Restock Frequency: "; cin >> restockFreq;
                grocery.addRareItem(id, restockFreq);
                break;
            case 10:
                grocery.displayRareItems();
                break;
            case 11:
                cout << "Enter low stock threshold: "; cin >> qty;
                grocery.checkLowStock(qty);
                break;
            case 12:
                grocery.calculateTotalInventoryValue();
                break;
...
// function to choose between test case and user menu
void runInventoryDemo() {
    int option;
    cout << "\nChoose Mode:\n";
    cout << "1. Run Demo Test Cases\n";
    cout << "2. Manual User Menu\n";
    cout << "Enter your choice: ";
    cin >> option;
